...
import com.shatteredpixel.shatteredpixeldungeon.items.scrolls.ScrollOfForgetting;
...
public class Generator {
	...
	public enum Category {
		...
		static {
			...
			SCROLL.defaultProbs = new float[]{ 0, 6, 5, 4, 3, 3, 3, 2, 2, 2, 2, 2, 1 };
